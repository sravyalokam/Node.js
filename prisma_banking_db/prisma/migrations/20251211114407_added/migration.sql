...
-- AddForeignKey
ALTER TABLE "account_schema"."accounts_new" ADD CONSTRAINT "accounts_new_customer_id_fkey" FOREIGN KEY ("customer_id") REFERENCES "customer_schema"."customers"("customer_id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "loan_schema"."loans" ADD CONSTRAINT "loans_customer_id_fkey" FOREIGN KEY ("customer_id") REFERENCES "customer_schema"."customers"("customer_id") ON DELETE RESTRICT ON UPDATE CASCADE;
